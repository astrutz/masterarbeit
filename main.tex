...
\author{Alexander Gabriel \textsc{Strutz}} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
%	ACRONYMS + GLOSSARY
%----------------------------------------------------------------------------------------
\newglossarystyle{modlist}{%
  \setglossarystyle{list}%
  \renewcommand{\glsgroupskip}{}
}

\newglossarystyle{modaltlist}{%
  \setglossarystyle{altlist}%
  \renewcommand{\glsgroupskip}{}
}

\setglossarystyle{modlist}
...
\addcontentsline{toc}{chapter}{eiddddd} % Adds line into table of contents
